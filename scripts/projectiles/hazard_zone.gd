...
func _draw() -> void:
	...
	if mobile_readability:
		draw_arc(Vector2.ZERO, radius + 1.0, 0.0, TAU, 64, Color(0.015, 0.018, 0.024, 0.92), 7.0)
		draw_arc(Vector2.ZERO, radius * 0.72, 0.3, TAU + 0.3, 48, Color(0.015, 0.018, 0.024, 0.72), 4.0)
	...
	draw_arc(Vector2.ZERO, radius, 0.0, TAU, 64, Color(color.r, color.g, color.b, 0.86 if mobile_readability else 0.72), 4.5 if mobile_readability else 2.5)
	draw_arc(Vector2.ZERO, radius * 0.72, 0.3, TAU + 0.3, 48, Color(0.58, 0.95, 1.0, 0.46 if mobile_readability else 0.34), 2.4 if mobile_readability else 1.25)
